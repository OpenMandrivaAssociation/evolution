...
Patch2:		evolution-2.27.2-fix-pst-build.patch
Patch4:		evolution-2.27.4-enable-deprecated-glib.patch
...
Obsoletes: nautilus-sendto-evolution <= 1.1.4.1
Provides: nautilus-sendto-evolution
